...
<head>
    ...
    <title>{{ $pageTitle }} - CEET Incidents</title>
...
<body class="ceet-incidents-index-page">
    <div class="ceet-incidents-shell" data-incidents-index>
        <div class="ceet-incidents-overlay" data-incidents-overlay></div>

        <aside class="ceet-incidents-sidebar" data-incidents-sidebar>
            <div class="ceet-incidents-brand">
                <div class="ceet-incidents-brand-logo">
            ...
            <nav class="ceet-incidents-nav" aria-label="Navigation principale">
                @include('partials.ceet-role-nav', ['linkClass' => 'ceet-incidents-nav-link'])
            </nav>

            <div class="ceet-incidents-sidebar-user">
                <div class="ceet-incidents-sidebar-user-main">
                    <div class="ceet-incidents-avatar">{{ $initials }}</div>
                ...
                <form action="{{ $safeRoute('logout', [], '#') }}" method="POST" class="ceet-incidents-logout-form">
                    @csrf

                    <button type="submit" class="ceet-incidents-logout-button">
        ...
        <header class="ceet-incidents-topbar">
            <button type="button" class="ceet-incidents-menu-btn" data-incidents-sidebar-toggle aria-label="Ouvrir le menu">
                <span class="material-symbols-outlined" aria-hidden="true">menu</span>
            </button>

            <form action="{{ $safeRoute($routeName, [], '/incidents') }}" method="GET" class="ceet-incidents-top-search">
            ...
            <div class="ceet-incidents-top-actions">
                <a href="{{ $safeRoute('notifications.index', [], '#') }}" class="ceet-incidents-icon-btn" aria-label="Notifications">
                    <span class="material-symbols-outlined" aria-hidden="true">notifications</span>
                    <span class="ceet-incidents-notification-dot"></span>
                </a>

                <a href="{{ $safeRoute('profile.edit', [], '/profile') }}" class="ceet-incidents-icon-btn" aria-label="Aide et profil">
                    <span class="material-symbols-outlined" aria-hidden="true">help_outline</span>
                </a>

                <div class="ceet-incidents-top-divider"></div>

                <div class="ceet-incidents-top-user">
                    <span>{{ $userName }}</span>
                    <div class="ceet-incidents-avatar is-small">{{ $initials }}</div>
                </div>
            </div>
        </header>
