...
class CauseController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('catalogues.causes.index')->with('success', 'Cause créée.');
    }
    ...
    public function update(Request $request, Cause $cause): RedirectResponse
    {
        ...
        return redirect()->route('catalogues.causes.index')->with('success', 'Cause mise à jour.');
    }

    public function destroy(Cause $cause): RedirectResponse
    {
        $cause->delete();
        return redirect()->route('catalogues.causes.index')->with('success', 'Cause supprimée.');
    }
}
